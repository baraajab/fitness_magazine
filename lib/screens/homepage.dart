        ...
        body: Column(
          children: [
            ...
            Expanded(
              child: TabBarView(
                children: [
                  AdvicebCard(advices: nutrition),
                  AdvicebCard(advices: health),
                  AdvicebCard(advices: beauty),
                  AdvicebCard(advices: fitness),
                ],
              ),
            ),
          ],
...
class AdvicebCard extends StatelessWidget {
  final List<Advice> advices;
  const AdvicebCard({super.key, required this.advices});
